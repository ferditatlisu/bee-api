...
class ChangeOffsetOfGroupHandler():
    def __init__(self, kafka_service: KafkaServiceInterface, redis_service: RedisService, group_id: str, topic_name: str, offset_type: OffsetType, value):
    ...
    def handle(self):    
        consumer, offsets = GetNewOffsetHandler(self.kafka_service, self.group_id, self.topic_name,
                                                self.offset_type, self.value).handle()
